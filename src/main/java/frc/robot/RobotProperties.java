...
public interface RobotProperties {
        ...
        public static final int LOWER_SHOOTER_SHORT_VELOCITY = 1000, UPPER_SHOOTER_SHORT_VELOCITY = 1925; // Low shot
        public static final int LOWER_SHOOTER_YEET_VELOCITY = 6000, UPPER_SHOOTER_YEET_VELOCITY = 6000; // Yeet shot
